...
function handleURLChange(newUrl) {
  ...
  if (document.querySelector('.questloader-button-container')) {
      return;
  }
...
function clearExistingButtons() {
  document.querySelectorAll(".questloader-button-container")
...
function createFloatingButtons() {
  ...
  container.className = "questloader-button-container";
      ...
      if (important) {
        const customContent = (header, _) => {
          const headerText = document.createTextNode(
            "It seems like QuestLoader wasn't able to generate all required download links. This is most likely the case because you don't own the content or have been logged out.",
          );
